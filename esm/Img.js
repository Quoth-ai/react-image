...
import { i as imagePromiseFactory, u as useImage } from './useImage-ce16c30b.js';

var _excluded = ["decode", "src", "loader", "unloader", "container", "loaderContainer", "unloaderContainer", "imgPromise", "crossorigin", "useSuspense", "loadTimeout"];
...
function Img(_ref) {
  var _ref$decode = _ref.decode,
      ...
      _ref$loadTimeout = _ref.loadTimeout,
      loadTimeout = _ref$loadTimeout === void 0 ? null : _ref$loadTimeout,
